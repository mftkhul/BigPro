...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #Student id
        studentId_label = Label(left_frame,text="Nim:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        studentId_label.grid(row=0,column=0,padx=5,pady=5,sticky=W)

        studentId_entry = ttk.Entry(left_frame,textvariable=self.var_nim,width=15,font=("verdana",12,"bold"))
        studentId_entry.grid(row=0,column=1,padx=5,pady=5,sticky=W)

        #Student Roll
        student_roll_label = Label(left_frame,text="No.Absen:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        student_roll_label.grid(row=0,column=2,padx=5,pady=5,sticky=W)

        student_roll_entry = ttk.Entry(left_frame,textvariable=self.var_absen,width=15,font=("verdana",12,"bold"))
        ...
        student_name_entry = ttk.Entry(left_frame,textvariable=self.var_nama,width=15,font=("verdana",12,"bold"))
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("Nim","Absen","Nama","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport_left.heading("Nim",text="Nim")
        self.attendanceReport_left.heading("Absen",text="No. Absen")
        self.attendanceReport_left.heading("Nama",text="Nama")
        ...
        # Set Width of Colums 
        self.attendanceReport_left.column("Nim",width=100)
        self.attendanceReport_left.column("Absen",width=100)
        self.attendanceReport_left.column("Nama",width=100)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("Nim","Absen","Nama","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.heading("Nim",text="Nim")
        self.attendanceReport.heading("Absen",text="No.Absen")
        self.attendanceReport.heading("Nama",text="Nama")
        ...
        # Set Width of Colums 
        self.attendanceReport.column("Nim",width=100)
        self.attendanceReport.column("Absen",width=100)
        self.attendanceReport.column("Nama",width=100)
    ...
    def update_data(self):
        if self.var_nim.get()=="" or self.var_absen.get=="" or self.var_nama.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set Nim=%s,Absen=%s,Nama=%s,Time=%s,Date=%s,Attend=%s where Nim=%s",( 
                    self.var_nim.get(),
                    self.var_absen.get(),
                    self.var_nama.get(),
                    self.var_time.get(),
        ...
        if self.var_nim.get()=="":
            ...
            try:
                ...
                if delete>0:
                    conn = mysql.connector.connect(username='root', password='25desember',host='localhost',database='face_recognition',port=3306)
                    mycursor = conn.cursor() 
                    sql="delete from stdattendance where Nim=%s"
    ...
    #             udate = i[4]
    #             uattend = i[5]
    #             qury = "INSERT INTO stdattendance(std_id, std_roll_no, std_name, Time, Date, Attend) VALUES(%s,%s,%s,%s,%s,%s)"
