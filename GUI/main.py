...
# This part is image labels setting start 
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Informasi Siswa",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1 = Button(bg_img,command=self.attendance_pannel,text="Presensi",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        hlp_b1_1 = Button(bg_img,command=self.helpSupport,text="Bantuan",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Training Data",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
