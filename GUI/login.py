...
class Login:
    def __init__(self,root):
        ...
        #label2 
        password =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="white",bg="#002B53")
        password.place(x=30,y=230)

        #entry2 
        self.txtpassword=ttk.Entry(frame1,font=("times new roman",15,"bold"))
        self.txtpassword.place(x=33,y=260,width=270)
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpassword.get()==""):
            ...
            mycursor.execute("select * from users where email=%s and password=%s",(
                self.txtuser.get(),
            ...
            if row==None:
                ...
                open_min=messagebox.askyesno("Alert","Apakah anda akan login?")
                if open_min>0:
                    self.new_window=Toplevel(self.root)
...
#=======================Reset Passowrd Function=============================
    ...
    #         mycursor = conn.cursor()
    #         query=("select * from users where email=%s and ss_que=%s and s_ans=%s")
...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Smart Attendance System - Face Recognition",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Panel Siswa",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
